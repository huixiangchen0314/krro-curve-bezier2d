...
(def lib 'top.kzre/krro-curve-bezier2d)
(def version "0.1.0")
(def class-dir "target/classes")
(def basis (b/create-basis {:project "deps.edn"}))
(def jar-file "target/krro-curve-bezier2d-0.1.0.jar")            ;; 硬编码，与 Makefile 一致
(def uber-file "target/krro-curve-bezier2d-0.1.0-standalone.jar")
